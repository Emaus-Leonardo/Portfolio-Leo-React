  ...
  return (
    ...
    >
      <div className="container mx-auto h-full relative flex items-center justify-center">
        <div className="flex flex-col lg:flex-row h-auto items-center justify-center gap-x-24 
        text-center lg:text-left lg:pt-16 pt-[100%] md:pt-96 order-2 lg:order-none">
          ...
          >
            ...
            <p className="mb-12">
              ...
              Pellentesque augue odio, fermentum vel venenatis quis,
              sollicitudin quis purus.
              <br />
              <br />
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Odit
              earum quidem adipisci sunt a quae, aut consectetur, br veniam
              placeat incidunt quaerat obcaecati inventore, dignissimos
              repellat consequuntur voluptas beatae facilis iusto?
            </p>
            ...
            <Link
              to="/projects"
              className="w-[230px] h-[60px] bg-[black] flex justify-center items-center text-white font-bold mt-7 hover:shadow-lg transition-all"
            >
              My Projects
            </Link>
          </motion.div>
